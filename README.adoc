...
=== When should you start using scripts?
...
*Use scripts for isolated tasks.  
Adopt a command runner once scripts become a system.*
...
Cross-platform compatibility and ease of set-up across different environments are important considerations when choosing a command runner.
...
* https://fnox.jdx.dev/[FNOX - Fort Knox for your secrets]
